  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Estado actual de las solicitudes</h1>
          </div><!-- /.col -->
...
<script>
  ...
  var ctxMontos = document.getElementById('graficoMontos').getContext('2d');

  // Configuración del gráfico de montos
  var dataMontos = {
    labels: [],
    datasets: [{
      label: 'Montos de Crédito',
      data: [],
  ...
  function actualizarGrafico() {
    $.ajax({
      url: 'obtenerDatos.php', // Reemplaza esto con la ruta correcta
      type: 'GET',
      dataType: 'json',
      success: function (datos) {
        // Limpiar datos antiguos
        dataMontos.labels = [];
        dataMontos.datasets[0].data = [];

        // Agregar nuevos datos
        datos.forEach(function (credito) {
          dataMontos.labels.push(credito.nombre);
          dataMontos.datasets[0].data.push(credito.monto);
        });
  ...
  // Crear el gráfico de montos
  var chartMontos = new Chart(ctxMontos, {
    type: 'bar',
    data: dataMontos,
    options: optionsMontos
  });

  // Actualizar el gráfico al cargar la página
  actualizarGrafico();

  // Puedes llamar a esta función cuando sea necesario para actualizar el gráfico
  // actualizarGrafico();
</script>
